...
public class CgminerAPIDEFAULT
{
    ...
    /*
    this.ip = ip;
    this.worker = ""; User=ZKmine.Home001 pools
    this.model = ""; [Type] => Antminer S19j Pro stats
    this.chipTemp = new int[]{0, 0, 0};[temp2_1] => 85 [temp2_2] =>  [temp2_3] => 84 stats
    this.hashrate5s = 0.0F; [GHS 5s] => 103705.94 stats
    this.uptime = "";
    this.status = "";
    */
    ...
    public CgminerAPIDEFAULT(String command, String _ip, String _port) throws Exception
    {
        InetAddress ip;
        int port;
